...
def neuralData():
    ...
    location = [str(s).replace('1', '1') for s in location]
    location = [str(s).replace('2', '1') for s in location]
    location = [str(s).replace('4', '1') for s in location]
    location = [str(s).replace('7', '1') for s in location]
    location = [str(s).replace('8', '1') for s in location]
    
    location = [str(s).replace('9', '2') for s in location]
    location = [str(s).replace('17', '2') for s in location]
    
    location = [str(s).replace('3', '3') for s in location]
    location = [str(s).replace('3.', '3') for s in location]
    location = [str(s).replace('5', '3') for s in location]
    location = [str(s).replace('13', '3') for s in location]
    
    location = [str(s).replace('6W', '4') for s in location]
    location = [str(s).replace('6w', '4') for s in location]
    location = [str(s).replace('12', '4') for s in location]
    location = [str(s).replace('10', '4') for s in location]
    location = [str(s).replace('20', '4') for s in location]
    location = [str(s).replace('22', '4') for s in location]
    
    location = [str(s).replace('Other', '5') for s in location]
    location = [str(s).replace('nan', '5') for s in location]
    location = [str(s).replace('6', '5') for s in location]
    location = [str(s).replace('14', '5') for s in location]
    location = [str(s).replace('16', '5') for s in location]
    location = [str(s).replace('18', '5') for s in location]
    
    location = [str(s).replace('11', '6') for s in location]
    location = [str(s).replace('15', '6') for s in location]
    location = [str(s).replace('22', '6') for s in location]
    location = [str(s).replace('24', '6') for s in location]
